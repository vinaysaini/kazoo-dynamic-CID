    ...
    [{description,"RabbitMQ"},
     ...
     {modules,
         [app_utils,background_gc,credit_flow,delegate,delegate_sup,dtree,
          ...
          rabbit_prelaunch,rabbit_queue_collector,rabbit_queue_decorator,
          rabbit_queue_index,rabbit_reader,rabbit_registry,
          rabbit_restartable_sup,rabbit_router,rabbit_runtime_parameter,
          rabbit_runtime_parameters,rabbit_runtime_parameters_test,
          rabbit_sasl_report_file_h,rabbit_ssl,rabbit_sup,rabbit_table,
          rabbit_tests,rabbit_tests_event_receiver,rabbit_trace,rabbit_types,
          rabbit_upgrade,rabbit_upgrade_functions,rabbit_variable_queue,
          rabbit_version,rabbit_vhost,rabbit_vm,rabbit_writer,
          supervised_lifecycle,supervisor2,supervisor2_tests,tcp_acceptor,
